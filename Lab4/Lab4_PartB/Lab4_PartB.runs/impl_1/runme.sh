...
HD_PWD='/home/ecelrc/students/cjanecka/EE316L/Lab4/Lab4_PartB/Lab4_PartB.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log edge_detector.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source edge_detector.tcl -notrace
