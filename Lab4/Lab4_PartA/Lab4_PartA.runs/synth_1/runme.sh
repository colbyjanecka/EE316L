...
HD_PWD='/home/ecelrc/students/cjanecka/EE316L/Lab4/Lab4_PartA/Lab4_PartA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clks.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clks.tcl
