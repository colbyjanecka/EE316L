...
HD_PWD='/home/ecelrc/students/cjanecka/EE316L/Lab4/Lab4_PartA/Lab4_PartA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log clks.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source clks.tcl -notrace
